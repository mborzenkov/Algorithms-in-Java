...
/** Tests all sorting algorighms in Sortings.java. */
public class SortingsTest {
    ...
    private enum SortingTypes {
        ...
        SortingTypes(String representation) { this.representation = representation; }
    ...
    private void testSortOnArray(int[] inputArray, String nameOfArray, SortingTypes sortingType) {
        ...
        if (PRINT_TIME) {
            System.out.println("SIZE: " + ARRAYS_SIZE_FORMATTED + " ints. TIME: " + (end - start) + " ms. Sorted " + nameOfArray + " with " + sortingType);
        }
